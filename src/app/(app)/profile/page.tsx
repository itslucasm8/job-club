    ...
    <div className="px-4 sm:px-5 lg:px-7 py-5 pb-24 lg:pb-10 max-w-lg">
      ...
      <div className="text-center px-5 py-7 bg-gradient-to-br from-purple-700 to-purple-500 rounded-2xl text-white mb-5">
        ...
        <div className="flex justify-center gap-8 mt-4">
          <div className="text-center"><div className="text-2xl font-extrabold">0</div><div className="text-[11px] opacity-70">Sauvegardés</div></div>
      ...
      <div className="space-y-0.5 mb-5">
        <MenuItem icon="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" label="Mes offres sauvegardées" />
...
function MenuItem({ icon, label }: { icon: string; label: string }) {
  return (
    <button className="flex items-center justify-between w-full px-4 py-3.5 bg-white rounded-lg border border-stone-200 hover:border-purple-300 transition">
