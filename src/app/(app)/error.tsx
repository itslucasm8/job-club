...
export default function AppError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4">
      ...
      <h2 className="text-lg font-bold text-stone-800 mb-2">Une erreur est survenue</h2>
      <p className="text-sm text-stone-500 mb-6 text-center max-w-sm">
        Cette page a rencontré un problème. Tu peux réessayer ou revenir au fil d&apos;offres.
      </p>
