...
const tabs = [
  ...
  { href: '/states', label: 'States', icon: 'M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z M12 10m-3 0a3 3 0 106 0 3 3 0 00-6 0' },
  { href: '/admin', label: 'Publier', icon: 'M12 5v14 M5 12h14', adminOnly: true },
  { href: '/profile', label: 'Profil', icon: 'M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2 M12 7m-4 0a4 4 0 108 0 4 4 0 00-8 0' },
]
